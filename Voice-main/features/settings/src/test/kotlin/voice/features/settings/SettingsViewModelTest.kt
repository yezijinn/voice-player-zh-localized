...
class SettingsViewModelTest {
  ...
  private val themeColorSchemeStore = MemoryDataStore(ThemeColorScheme.Red)
  ...
  fun `view state defaults to follow system and voice blue`() = scope.runTest {
    backgroundScope.launchMolecule(RecompositionMode.Immediate) {
      ...
      awaitItem().let {
        ...
        assertEquals(expected = ThemeColorScheme.Red, actual = it.themeColorScheme)
      }
    }
  }
  ...
  fun `selecting dynamic color updates view state`() = scope.runTest {
    backgroundScope.launchMolecule(RecompositionMode.Immediate) {
      ...
      assertEquals(expected = ThemeColorScheme.Red, actual = awaitItem().themeColorScheme)
