...
internal fun ThemeModeDialog(
  ...
  // 浅色排在第一
  val orderedModes = listOf(ThemeMode.Light, ThemeMode.Dark, ThemeMode.FollowSystem)
  AlertDialog(
    ...
    text = {
      Column {
        orderedModes.forEach { themeMode ->
          SelectionDialogItem(
...
internal fun ThemeColorSchemeDialog(
  ...
  // 青色排在第一
  val orderedSchemes = listOf(
    ThemeColorScheme.Teal,
    ThemeColorScheme.Red,
    ThemeColorScheme.Green,
  ...
  AlertDialog(
    ...
    text = {
      Column {
        orderedSchemes.forEach { themeColorScheme ->
          SelectionDialogItem(
...
private fun ThemeColorScheme.label(): String {
  return when (this) {
    ThemeColorScheme.Red -> "红色"
    ThemeColorScheme.Green -> "绿色"
    ThemeColorScheme.Purple -> "紫色"
    ThemeColorScheme.Teal -> "青色（系统默认）"
    ThemeColorScheme.Orange -> "橙色"
