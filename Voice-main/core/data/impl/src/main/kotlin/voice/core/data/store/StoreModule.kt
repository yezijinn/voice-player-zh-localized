...
public interface StoreModule {
  ...
  private fun themeColorScheme(factory: VoiceDataStoreFactory): DataStore<ThemeColorScheme> {
    return factory.create(
      ...
      defaultValue = ThemeColorScheme.Teal,
    )
  }
  ...
  private fun skipStartSeconds(factory: VoiceDataStoreFactory): DataStore<Int> {
    return factory.int("skipStartSeconds", defaultValue = 0)
  }

  @Provides
  @SingleIn(AppScope::class)
  @SkipEndSecondsStore
  private fun skipEndSeconds(factory: VoiceDataStoreFactory): DataStore<Int> {
    return factory.int("skipEndSeconds", defaultValue = 0)
  }
