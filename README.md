...
在 [Releases](https://github.com/yezijinn/voice-player-zh-localized/releases) 页面下载最新 APK 文件，直接安装到手机即可。
...
- [自定义修改UI指南](自定��修改UI指南.md) - 如何自定义界面
